...
/**
 * На текущий момент класс DiscountCalculatorTest покрывает только один тест-кейс из пяти. Составьте ещё четыре теста, чтобы обеспечить полное покрытие класса DiscountCalculator.
