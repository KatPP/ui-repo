...
/**
 * Перед вами массив расходов за неделю — вы уже работали с подобным. Сделайте процесс редактирования трат более удобным:
 * добавьте в код возможность менять сумму расходов за любой день через консоль.
